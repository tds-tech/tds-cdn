/**
 * TDS AI Visibility Scanner — Webflow Embed v1.5.3
...
(function () {
  ...
  function renderStage2Teaser(root, domain, scanId, teaserData) {
    ...
    root.innerHTML = [
      ...
      '<p style="margin:0 0 8px;font-size:12px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#0d9488;">You’re getting access to one of our most exclusive tools — free</p>',
