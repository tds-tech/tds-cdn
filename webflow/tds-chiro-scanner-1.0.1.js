/**
 * TDS Chiro AI Visibility Scanner — Webflow Embed v1.0.1 (fork of dental v1.8.0)
...
(function () {
  ...
  var N8N_TEASER = 'https://ramsautomation.app.n8n.cloud/webhook/chiro-scanner-teaser';
  var N8N_POLL   = 'https://ramsautomation.app.n8n.cloud/webhook/ai-scanner-poll';
  var N8N_GATE   = 'https://ramsautomation.app.n8n.cloud/webhook/chiro-scanner-gate';
  ...
  var AI_SEO_URL = 'https://www.thedigitalsmile.com/chiro-ai-visibility-checker';
  ...
  var BOOK_A_CALL_URL = 'https://thedigitalsmile-seo.com/booking?utm_source=ai-scanner-chiro&utm_medium=report&utm_campaign=aivc-report';
  ...
  var SCAN_STEPS = [
    'Querying ChatGPT &amp; Perplexity for your office…',
  ...
  function renderCompetitors(comps, city) {
    ...
    return [
      ...
      '<p class="tds-comp-sub">When people ask AI for a chiropractor' + (city ? ' in ' + esc(city) : ' near you') + ', these names come up:</p>',
      '<ul>' + items + '</ul>',
      '</div>'
    ].join('');
  }
  ...
  function renderStage1(root) {
    root.innerHTML = [
      ...
      '<h2 class="tds-headline">Is your chiropractic office invisible to AI?</h2>',
      '<p class="tds-sub">ChatGPT and Gemini are the new search engines for patients.',
      ' Run a free scan to see if your office shows up, and exactly what to fix if it doesn’t.</p>',
      '<div class="tds-pills">',
  ...
  function renderStage3Report(root, data) {
    ...
    var name      = decodeEntities(data.practice_name) || data.domain || 'Your office';
