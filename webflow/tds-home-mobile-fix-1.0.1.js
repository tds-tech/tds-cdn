/* TDS homepage — mobile layout + nav-parity fix v1.0.1
   Loaded from tds-cdn in the Webflow footer. Two jobs, both mobile-only & idempotent:
   ...
   Desktop (>=992px) is never touched: every CSS rule is under max-width<=991. */
(function(){'use strict';
  /* (A) CSS */
