/**
 * TDS Med Spa AI Visibility Scanner — Webflow Embed v1.0.2 (fork of dental v1.7.1)
...
(function () {
  ...
  var CSS = [
    ...
    '.tds-card [tabindex="-1"]:focus,.tds-card [tabindex="-1"]:focus-visible{outline:none;box-shadow:none;}',
